    ...
    public static Map<String, String> statMap = new HashMap<>(){
        {
            ...
            put("Attack Damage Raw", "mainAttackDamageBonusRaw");
            put("Attack Damage", "mainAttackDamageBonus");
            put("Spell Damage Raw", "spellDamageBonusRaw");
            ...
            put("Earth Damage", "earthDamageBonus");
            put("Fire Damage", "fireDamageBonus");
            put("Water Damage", "waterDamageBonus");
            put("Air Damage", "airDamageBonus");
            put("Thunder Damage", "thunderDamageBonus");
